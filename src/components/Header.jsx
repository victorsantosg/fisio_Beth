...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-surface-container-highest/50 transition-all duration-300">
      ...
      <div
        className={`fixed inset-y-0 right-0 w-4/5 max-w-sm bg-surface-white/95 dark:bg-background/95 backdrop-blur-lg border-l border-surface-container-highest shadow-2xl z-40 flex flex-col justify-between p-6 transform transition-transform duration-300 ease-out ${
